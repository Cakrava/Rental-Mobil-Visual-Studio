...
Public Class cetak_lap_penyewa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TA2020022CS.cetak_lap_penyewa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcetak_lap_penyewa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cetak_lap_penyewa = New cetak_lap_penyewa()
        rpt.Site = Me.Site
        Return rpt
    End Function
