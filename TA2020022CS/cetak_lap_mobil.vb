...
Public Class cetak_lap_mobil
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TA2020022CS.cetak_lap_mobil.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcetak_lap_mobil
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cetak_lap_mobil = New cetak_lap_mobil()
        rpt.Site = Me.Site
        Return rpt
    End Function
